...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Franklin Samboni Castillo" => "sambonifranklin@gmail.com" }
  # Or just: spec.author    = "Franklin Samboni Castillo"
  # spec.authors            = { "Franklin Samboni Castillo" => "sambonifranklin@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Franklin Samboni Castillo"
  ...
  spec.source       = { :git => "https://github.com/FranklinSamboni/KnobControl.git", :tag => "1.0.1" }
